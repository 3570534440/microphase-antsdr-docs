...
[[English]](../../../../../en/html/device_and_usage_manual/ANTSDR_E_Series_Module/ANTSDR_E310_Reference_Manual/AntsdrE310_gnurdio.html)
...
使用前，您需要使用 fmcomms 固件。您可以在此处找到 fmcomms 固件的使用方法 [Unpacking examination](./AntsdrE310_fmcomms_cn.md)
